...
namespace IngameScript {
    static partial class Collect {
        ...
        public static bool IsLandingGearUnlocked(IMyLandingGear b) { return ((int)b?.LockMode == 0); } //TODO: Unlocked - Workaround this this is fixed

        public static bool IsLandingGearReadyToLock(IMyTerminalBlock b) { return IsLandingGearReadyToLock(b as IMyLandingGear); }
        public static bool IsLandingGearReadyToLock(IMyLandingGear b) { return ((int)b?.LockMode == 1); } //TODO: ReadyToLock - Workaround this this is fixed

        public static bool IsLandingGearLocked(IMyTerminalBlock b) { return IsLandingGearLocked(b as IMyLandingGear); }
        public static bool IsLandingGearLocked(IMyLandingGear b) { return ((int)b?.LockMode == 2); } //TODO: Locked - Workaround this this is fixed
    }
}
