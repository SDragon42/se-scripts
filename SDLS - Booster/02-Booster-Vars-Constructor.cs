...
namespace IngameScript {
    partial class Program {
        ...
        void LoadBlocks(bool force = false) {
            ...
            //GridTerminalSystem.GetBlocksOfType(StageClamps, b => IsOnThisGrid(b) && Collect.IsTagged(b, TAG_STAGING_CLAMP));
            //GridTerminalSystem.GetBlocksOfType(H2Tanks, IsOnThisGrid);
